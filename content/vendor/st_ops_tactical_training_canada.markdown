...
{{< entity_summary >}}
The Government of Canada spent an estimated **\$359.4K in 2021-2022** on contracts with ST OPS TACTICAL TRAINING CANADA.

Across 41 contracts active since the start of the 2017-2018 fiscal year, 5 have at least one amendment (12%). Of contracts with amendments, the average increase in dollar value was -13% and the average number of amendments was 1. Cumulatively these amendments represent an increase of \$-78.7K over the original contract values.

The average contract duration was 0.31 years, and the average contract value (not including contracts under \$10k) was \$296.6K. The longest contract was 3.02 years. The largest contract by value (including amendments) was \$8.0M.
