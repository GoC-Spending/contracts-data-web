...
Across 297 contracts active since the start of the 2017-2018 fiscal year, 35 have at least one amendment (12%). Of contracts with amendments, the average increase in dollar value was 8915010% and the average number of amendments was 2.91. Cumulatively these amendments represent an increase of \$25.4M over the original contract values.

The average contract duration was 1.51 years, and the average contract value (not including contracts under \$10k) was \$526.9K. The longest contract was 10.01 years. The largest contract by value (including amendments) was \$22.4M.
