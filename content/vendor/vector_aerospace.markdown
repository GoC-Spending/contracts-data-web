...
{{< entity_summary >}}
The Government of Canada spent an estimated **\$2.6M in 2021-2022** on contracts with VECTOR AEROSPACE.

Across 65 contracts active since the start of the 2017-2018 fiscal year, 8 have at least one amendment (12%). Of contracts with amendments, the average increase in dollar value was 203% and the average number of amendments was 1. Cumulatively these amendments represent an increase of \$2.4M over the original contract values.

The average contract duration was 0.05 years, and the average contract value (not including contracts under \$10k) was \$260.0K. The longest contract was 0.68 years. The largest contract by value (including amendments) was \$1.5M.
