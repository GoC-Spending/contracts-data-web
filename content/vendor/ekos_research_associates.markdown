...
{{< entity_summary >}}
The Government of Canada spent an estimated **\$1.8M in 2021-2022** on contracts with EKOS RESEARCH ASSOCIATES.

Across 92 contracts active since the start of the 2017-2018 fiscal year, 8 have at least one amendment (9%). Of contracts with amendments, the average increase in dollar value was 44% and the average number of amendments was 1. Cumulatively these amendments represent an increase of \$80.4K over the original contract values.

The average contract duration was 0.72 years, and the average contract value (not including contracts under \$10k) was \$102.4K. The longest contract was 1.86 years. The largest contract by value (including amendments) was \$286.5K.
