...
Across 209 contracts active since the start of the 2017-2018 fiscal year, 28 have at least one amendment (13%). Of contracts with amendments, the average increase in dollar value was 99% and the average number of amendments was 2.25. Cumulatively these amendments represent an increase of \$3.4M over the original contract values.

The average contract duration was 2.73 years, and the average contract value (not including contracts under \$10k) was \$53.0K. The longest contract was 9.92 years. The largest contract by value (including amendments) was \$1.5M.
