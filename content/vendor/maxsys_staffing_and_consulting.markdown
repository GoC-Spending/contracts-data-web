...
Across 239 contracts active since the start of the 2017-2018 fiscal year, 84 have at least one amendment (35%). Of contracts with amendments, the average increase in dollar value was 110% and the average number of amendments was 1.46. Cumulatively these amendments represent an increase of \$9.1M over the original contract values.
