...
description: The Government of Canada spent an estimated $501.2K
  in 2021-2022 on contracts with WYSSEN AVALANCHE CONTROL. The average
  contract duration was 1.6 year, and the average contract
  value (not including contracts under $10k) was $872.9K.
  The longest contract was 3.89 year. The largest contract
  by value (including amendments) was $3.5M.
most_recent_fiscal_year_total: '501.2K'
...
s433_total_amendment_increase_value_by_vendor: '383.4K'
s424_mean_duration_by_vendor: '1.6'
s421_mean_contract_value_by_vendor: '872.9K'
