...
description: The Government of Canada spent an estimated $677.9K
  in 2021-2022 on contracts with CNW GROUP. The average
  contract duration was 1.12 year, and the average contract
  value (not including contracts under $10k) was $43.8K.
  The longest contract was 4 year. The largest contract
  by value (including amendments) was $2.5M.
most_recent_fiscal_year_total: '677.9K'
...
s433_total_amendment_increase_value_by_vendor: '353.9K'
s424_mean_duration_by_vendor: '1.12'
s421_mean_contract_value_by_vendor: '43.8K'
