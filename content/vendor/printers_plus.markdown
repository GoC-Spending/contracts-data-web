...
Across 384 contracts active since the start of the 2017-2018 fiscal year, 25 have at least one amendment (7%). Of contracts with amendments, the average increase in dollar value was 13% and the average number of amendments was 1.84. Cumulatively these amendments represent an increase of \$824.8K over the original contract values.

The average contract duration was 1.05 years, and the average contract value (not including contracts under \$10k) was \$47.9K. The longest contract was 6.42 years. The largest contract by value (including amendments) was \$1.9M.
