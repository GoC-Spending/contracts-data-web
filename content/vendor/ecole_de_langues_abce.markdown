...
Across 515 contracts active since the start of the 2017-2018 fiscal year, 75 have at least one amendment (15%). Of contracts with amendments, the average increase in dollar value was 70% and the average number of amendments was 1.61. Cumulatively these amendments represent an increase of \$713.0K over the original contract values.

The average contract duration was 0.62 years, and the average contract value (not including contracts under \$10k) was \$22.9K. The longest contract was 4.5 years. The largest contract by value (including amendments) was \$250.6K.
