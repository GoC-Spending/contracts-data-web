...
This research was conducted by [Sean Boots](https://sboots.ca/), [Prof. Amanda Clarke](https://amandaclarke.ca/), [Anne Lajoie](https://www.linkedin.com/in/annemichelelajoie/), and [Chantal Brousseau](https://chantalbrousseau.xyz/) from the [School of Public Policy and Administration at Carleton University](https://carleton.ca/sppa/). It expands on [an earlier Ottawa Civic Tech project](https://goc-spending.github.io/about/) from 2017-2019. 
...
This data is provided as-is, and no guarantees are made for the accuracy of the data or the processes used to aggregate and analyze it. **Trends and total values should be considered estimates rather than precise values.** [See the methodology page for more details](/methodology/#calculate-spending-over-time).
