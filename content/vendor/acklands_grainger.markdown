...
{{< entity_summary >}}
The Government of Canada spent an estimated **\$2.7M in 2021-2022** on contracts with ACKLANDS GRAINGER.

Across 426 contracts active since the start of the 2017-2018 fiscal year, 14 have at least one amendment (3%). Of contracts with amendments, the average increase in dollar value was -15% and the average number of amendments was 1.21. Cumulatively these amendments represent an increase of \$-448.5K over the original contract values.

The average contract duration was 0.19 years, and the average contract value (not including contracts under \$10k) was \$34.9K. The longest contract was 3.02 years. The largest contract by value (including amendments) was \$2.1M.
